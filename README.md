...
## Outputs: 
### Core Dataset : _wi_unip_avg_val_screened.csv
> smallest dataset, most safe and confident\
(1) Get data with UniProt IDs (wi_unip);\
(2) Groupby smiles & sequence;\
(3) Screen SD < 1.0.

### Screened Pan-Genomic Dataset : _wi_wo_unip_avg_val_screened_0.csv
...
### Fine-Resolution Pan-Genomic Dataset :_wi_wo_unip_avg_val_screened_X.csv
