...
def Get_MNX_dicts():
    ...
    pickle_in1=open("./MNXScrapSavings/CPD01_smiles_MNXid_nme_dict.p","rb")
    smiles_MNXid_nme_dict = pickle.load(pickle_in1)
    pickle_in1.close()

    pickle_in1=open("./MNXScrapSavings/CPD01_nme_smiles_MNXid_dict.p","rb")
    nme_smiles_MNXid_dict = pickle.load(pickle_in1)
    pickle_in1.close()

    return smiles_MNXid_nme_dict, nme_smiles_MNXid_dict
...
def test():
    def read_smiles(dictionary, one_smiles):
        ...
        return 
    #====================================================================================================#
    smiles_id_nme_dict, nme_smiles_id_dict = Get_MNX_dicts()
